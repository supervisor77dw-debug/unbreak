...
const defaultKey = process.env.STRIPE_SECRET_KEY; // Optional legacy fallback

// Log available keys at startup (without exposing values)
if (typeof window === 'undefined') {
  console.log('[STRIPE] Key availability:', {
    STRIPE_SECRET_KEY_TEST: !!testKey,
    STRIPE_SECRET_KEY_LIVE: !!liveKey,
    STRIPE_SECRET_KEY: !!defaultKey,
    STRIPE_CHECKOUT_MODE: process.env.STRIPE_CHECKOUT_MODE || 'auto',
  });
}
 ...
 * Returns null if no key available (lazy init recommended via getStripeClient)
 */
