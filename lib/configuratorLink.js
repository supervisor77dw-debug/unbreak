...
import { getConfiguratorUrl, getShopUrl, buildConfiguratorUrl as buildConfigUrl } from './urls';

const CONFIGURATOR_BASE_URL = getConfiguratorUrl();
const DEFAULT_RETURN_URL = getShopUrl();
...
export function buildConfiguratorUrl(lang = 'de', returnUrl = null) {
  return buildConfigUrl(lang, returnUrl);
}
