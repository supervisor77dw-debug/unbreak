...
(function(window) {
    ...
    class ConfiguratorBridge {
        ...
        init(iframeEl, options = {}) {
            ...
            this.log(`Bridge initialized traceId=${this.traceId}`);
            ...
            this.log('Waiting for READY signal...');
        }
        ...
        handleMessage(event) {
            ...
            this.log(`Message received: ${data.type}`, data);
            ...
            switch (data.type) {
                ...
                case 'LOADING':
                    this.log(`Configurator loading: ${data.progress || 0}%`);
                    break;
